...
const placeDetailsByTitle: Record<string, PlaceDetail> = {
  'FILM电影时光书店': {
    ...
    status: '营业中',
    description:
      '坐落于上海市电影家协会大院内的老洋房中，是一家以电影、戏剧和艺术为主题的独立书店。庭院静谧幽雅，室内红木格调配合暗黄光线，适合慢慢翻阅、喝一杯咖啡，再从路线起点平静进入武康路一带。',
    price: '人均 ¥43',
    rating: '4.8',
    ratingCount: '1252',
    heroWordmark: 'FILM',
    ...
    reviews: [
      ...
      makeReview('film-2', '杰克', '1 周前', '安福路宝藏电影书店，老洋房环境很有氛围感，看书喝咖啡很惬意，影迷必逛。', 5, '#d9e4f5'),
      makeReview('film-3', '小艾', '1 个月前', '影视类书籍选得很专业，冷门画册和导演传记都能挖到，工作日来体验更安静。', 4, '#f0dfc8'),
    ],
    reminders: ['一个人阅读', '喜欢电影主题空间', '想轻松开启路线'],
    reminderNote: '周末下午人流会更密，若想安静停留，建议避开 14:00-16:30 的高峰时段。',
  },
  'RAC BAR（安福路店）': {
    title: 'RAC BAR（安福路店）',
